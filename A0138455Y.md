...
```
###### \src\main\java\seedu\flexitrack\commons\events\ui\StoragePathChangeEvent.java
``` java
...
```
###### \src\main\java\seedu\flexitrack\logic\commands\BlockCommand.java
``` java
/**
...
```
###### \src\main\java\seedu\flexitrack\logic\commands\ChangeStoragePathCommand.java
``` java
/**
 * 
...
```
###### \src\main\java\seedu\flexitrack\logic\commands\HelpCommand.java
``` java
...
```
###### \src\main\java\seedu\flexitrack\logic\commands\MarkCommand.java
``` java
package seedu.flexitrack.logic.commands;
...
```
###### \src\main\java\seedu\flexitrack\logic\commands\UnmarkCommand.java
``` java
package seedu.flexitrack.logic.commands;
...
```
###### \src\main\java\seedu\flexitrack\MainApp.java
``` java
    @Subscribe
...
```
###### \src\main\java\seedu\flexitrack\model\task\Name.java
``` java
    public boolean getIsBlock() {
        return isBlockPrefix.equals(BLOCK_PREFIX);
    }
```
###### \src\main\java\seedu\flexitrack\model\task\Task.java
``` java
...
```
###### \src\main\java\seedu\flexitrack\storage\StorageManager.java
``` java
    @Override
...
```
###### \src\main\java\seedu\flexitrack\ui\StatusBarFooter.java
``` java
    @Subscribe
    public void changeStoragePathRequestEvent(StoragePathChangeEvent event) {
...
```
###### \src\test\java\guitests\BlockCommandTest.java
``` java
package guitests;
...
```
###### \src\test\java\guitests\HelpCommandTest.java
``` java
package guitests;
...
```
###### \src\test\java\seedu\flexitrack\testutil\TestTask.java
``` java
