...
import harmony.mastermind.commons.util.XmlUtil;
import harmony.mastermind.model.TaskManager;
import harmony.mastermind.storage.XmlSerializableTaskManager;
import harmony.mastermind.testutil.TaskManagerBuilder;
...
public class XmlUtilTest {
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        dataToWrite = new XmlSerializableTaskManager(builder.withPerson(TestUtil.generateSampleTaskData().get(0)).withTag("Friends").build());
