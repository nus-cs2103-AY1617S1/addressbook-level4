...
import static harmony.commons.core.Messages.*;
...
public class LogicManagerTest {
    ...
    public void execute_add_invalidPersonData() throws Exception {
        ...
        assertCommandBehavior(
                "add Valid Name p/not_numbers e/valid@e.mail a/valid, address", Time.MESSAGE_PHONE_CONSTRAINTS);
        assertCommandBehavior(
