...
public class ConfirmLogicCommandTest extends LogicCommandTest {
  ...
  @Test
  public void execute_confirm_invalidRsvTaskIndex_ErrorMessageShown() throws Exception {
    assertCommandBehavior("confirm 2 3", MESSAGE_INVALID_RSV_TASK_DISPLAYED_INDEX);
  }

  @Test
  public void execute_confirm_invalidRsvTaskDateTimeIndex_ErrorMessageShown() throws Exception {
    ...
    assertCommandBehavior("confirm 1 3", Messages.MESSAGE_INVALID_DATETIME_DISPLAYED_INDEX,
  ...
  public void execute_confirm_success() throws Exception {
    ...
    assertCommandBehaviorWithRsvTaskList("confirm 1 1 /p h /t tag", expectedMessage, expectedTars,
        taskList, rsvTaskList);
  ...
  public void execute_undoAndRedo_confirmSuccessful() throws Exception {
    ...
    assertCommandBehavior(UndoCommand.COMMAND_WORD, String.format(UndoCommand.MESSAGE_SUCCESS, ""),
        expectedTars, expectedTars.getTaskList());
    ...
    assertCommandBehavior(RedoCommand.COMMAND_WORD, String.format(RedoCommand.MESSAGE_SUCCESS, ""),
        expectedTars, expectedTars.getTaskList());
