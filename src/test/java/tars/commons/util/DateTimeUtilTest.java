...
public class DateTimeUtilTest {
  ...
  public void isDateTimeWithinRange_dateTimeWithoutStartDate() throws Exception {
    ...
    assertTrue(DateTimeUtil.isDateTimeWithinRange(dateTimeSourceWithoutStartDate,
        dateTimeQueryWithoutStartDate));
    assertFalse(DateTimeUtil.isDateTimeWithinRange(dateTimeSourceWithoutStartDate,
  ...
  public void isDateTimeConflicting_dateTimeConflicts() throws Exception {
    ...
    assertTrue(DateTimeUtil.isDateTimeConflicting(dateTimeSource, conflictingDateTimeQuery));
    assertTrue(DateTimeUtil.isDateTimeConflicting(dateTimeSource, conflictingDateTimeQuery2));
  }
  ...
  public void isDateTimeConflicting_dateTimeNotConflicting() throws Exception {
    ...
    assertFalse(DateTimeUtil.isDateTimeConflicting(dateTimeSource, dateTimeQueryOutOfRange));
    assertFalse(DateTimeUtil.isDateTimeConflicting(dateTimeSource, dateTimeAdjacent));
  }
  ...
  public void getDurationInMinutesBetweenTwoLocalDateTime_success() {
    ...
    assertEquals(DateTimeUtil.getDurationInMinutesBetweenTwoLocalDateTime(ldt1, ldt2),
        "4 hr 52 min");
  }
