...
public class ConfigUtilTest {
    ...
    private static String TEST_DATA_FOLDER = FileUtil
    ...
    @Test
    public void read_notJasonFormat_exceptionThrown()
    ...
    private Config getTypicalConfig() {
        ...
        config.setTarsFilePath("tars.xml");
        config.setTarsName("TypicalTarsName");
        return config;
    }

    private Optional<Config> read(String configFileInTestDataFolder)
            throws DataConversionException {
        String configFilePath = addToTestDataPathIfNotNull(
                configFileInTestDataFolder);
    ...
    public void saveConfig_allInOrder_success()
        ...
        String configFilePath = testFolder.getRoot() + File.separator
                + "TempConfig.json";
    ...
    private String addToTestDataPathIfNotNull(
            String configFileInTestDataFolder) {
        return configFileInTestDataFolder != null
                ? TEST_DATA_FOLDER + configFileInTestDataFolder : null;
    }
