...
public class TestUtil {
    ...
    private static Task[] getSampletaskData() {
        try {
            return new Task[]{
                    new Todo(new Name("TT 11"), new StartDate("01-11-2016"), new EndDate("02-11-2016"), new Priority("1"), new Done("done")),
                    new Todo(new Name("Assignment 12"), new StartDate("02-11-2016"), new EndDate("03-11-2016"), new Priority("2"), new Done("done")),
                    new Todo(new Name("Assignment 13"), new StartDate("03-11-2016"), new EndDate("03-11-2016"), new Priority("3"), new Done("done")),
                    new Todo(new Name("Assignment 14"), new StartDate("04-11-2016"), new EndDate("05-11-2016"), new Priority("4"), new Done("done")),
                    new Todo(new Name("Assignment 15"), new StartDate("05-11-2016"), new EndDate("06-11-2016"), new Priority("5"), new Done("done")),
                    new Todo(new Name("Assignment 16"), new StartDate("06-11-2016"), new EndDate("07-11-2016"), new Priority("6"), new Done("done")),
                    new Todo(new Name("Assignment 17"), new StartDate("07-11-2016"), new EndDate("08-11-2016"), new Priority("7"), new Done("done")),
            };
    ...
    private static Event[] getSampleeventData() {
        try {
            return new Event[]{
                    new Event(new Name("EE 11"), new StartDate("01-11-2016"), new EndDate("02-11-2016"), new StartTime("1000"), new EndTime("1030"), new Done("done")),
                    new Event(new Name("Essignment 12"), new StartDate("02-11-2016"), new EndDate("02-11-2016"),  new StartTime("1000"), new EndTime("1030"), new Done("done")),
                    new Event(new Name("Essignment 13"), new StartDate("03-11-2016"), new EndDate("02-11-2016"),  new StartTime("1100"), new EndTime("1130"), new Done("done")),
                    new Event(new Name("Essignment 14"), new StartDate("04-11-2016"), new EndDate("02-11-2016"),  new StartTime("1200"), new EndTime("1230"), new Done("done")),
                    new Event(new Name("Essignment 15"), new StartDate("05-11-2016"), new EndDate("02-11-2016"),  new StartTime("1300"), new EndTime("1330"), new Done("done")),
                    new Event(new Name("Essignment 16"), new StartDate("06-11-2016"), new EndDate("02-11-2016"),  new StartTime("1400"), new EndTime("1430"), new Done("done")),
                    new Event(new Name("Essignment 17"), new StartDate("07-11-2016"), new EndDate("02-11-2016"),  new StartTime("1500"), new EndTime("1530"), new Done("done")),
            };
        } catch (IllegalValueException e) {
            assert false;
            //not possible
    ...
    private static Deadline[] getSampledeadlineData() {
        try {
            return new Deadline[]{
                    new Deadline(new Name("DD 11"), new StartDate("01-11-2016"), new EndTime("1100"), new Done("done")),
                    new Deadline(new Name("Dssignment 12"), new StartDate("02-11-2016"), new EndTime("1200"), new Done("done")),
                    new Deadline(new Name("Dssignment 13"), new StartDate("03-11-2016"), new EndTime("1300"), new Done("done")),
                    new Deadline(new Name("Dssignment 14"), new StartDate("04-11-2016"), new EndTime("1400"), new Done("done")),
                    new Deadline(new Name("Dssignment 15"), new StartDate("05-11-2016"), new EndTime("1500"), new Done("done")),
                    new Deadline(new Name("Dssignment 16"), new StartDate("06-11-2016"), new EndTime("1600"), new Done("done")),
                    new Deadline(new Name("Dssignment 17"), new StartDate("07-11-2016"), new EndTime("1700"), new Done("done")),
            };
        } catch (IllegalValueException e) {
            assert false;
            //not possible
