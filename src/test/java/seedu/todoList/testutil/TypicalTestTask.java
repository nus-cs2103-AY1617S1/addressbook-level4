...
public class TypicalTestTask {
    ...
    public static void loadTodoListWithSampleData(TaskList ab) {
        ...
        try {
            ab.addTask(new Todo(new Name("project 1"), new StartDate("26-10-2017"), new EndDate("27-10-2017"), new Priority("2"), new Done("false")));
            ab.addTask(new Todo(new Name("todo 2"), new StartDate("11-11-2017"), new EndDate("12-11-2017"), new Priority("2"), new Done("false")));
            ab.addTask(new Todo(new Name("todo 3"), new StartDate("11-11-2017"), new EndDate("12-11-2017"), new Priority("2"), new Done("false")));
            ab.addTask(new Todo(new Name("todo 7"), new StartDate("11-11-2017"), new EndDate("12-11-2017"), new Priority("2"), new Done("false")));
            ab.addTask(new Todo(new Name("todo 4"), new StartDate("11-11-2017"), new EndDate("12-11-2017"), new Priority("2"), new Done("false")));
            ab.addTask(new Todo(new Name("todo 5"), new StartDate("11-11-2017"), new EndDate("12-11-2017"), new Priority("2"), new Done("false")));
            ab.addTask(new Todo(new Name("todo 6"), new StartDate("11-11-2017"), new EndDate("12-11-2017"), new Priority("2"), new Done("false")));
