...
public class XmlUtilTest {
    ...
    private static final File VALID_FILE = new File(TEST_DATA_FOLDER + "validTodo.xml");
    private static final File TEMP_FILE = new File(TestUtil.getFilePathInSandboxFolder("tempTodo.xml"));
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        dataToWrite = new XmlSerializableTaskManager(builder.withItem(TestUtil.generateSampleItemData().get(0)).withTag("Friends").build());
