...
public class TypicalTestActivities {
    ...
    public TypicalTestActivities() {
        try {
            ...
            event = new Activitybuilder().withEvent(Activity.EVENT_TYPE, new ActivityName("CS2103T tutorial"), new Note("Don't Sleep"), new ActivityDate("10-08-2016"), new ActivityTime("1500"), new ActivityDate("10-12-2016"), new ActivityTime("1800"), new Completed(Completed.UNCOMPLETED_ACTIVITY)) .build();   
