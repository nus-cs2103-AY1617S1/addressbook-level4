...
public class SequentialParserTest {
    ...
    @Test
    public void extractText_noKeywords() throws Exception {
    ...
    @Test
    public void extractText_trims() throws Exception {
    ...
    @Test
    public void extractText_1Keyword() throws Exception {
    ...
    @Test
    public void extractText_2Keywords() throws Exception {
    ...
    @Test
    public void extractText_caseInsensitiveKeywords() throws Exception {
    ...
    @Test
    public void extractText_noMatchingKeywords() throws Exception {
    ...
    @Test
    public void extractText_notMatchSubstrings() throws Exception {
    ...
    @Test
    public void extractWords_noWords() throws Exception {
        sequentialParser.setInput("");
        assertTrue(sequentialParser.extractWords().isEmpty());
    }

    @Test
    public void extractWords_1Word() throws Exception {
    ...
    @Test
    public void extractWords_2Words() throws Exception {
    ...
    @Test
    public void extractFirstWord_noWord() throws Exception {
        sequentialParser.setInput("");
        assertTrue(!sequentialParser.extractFirstWord().isPresent());
    }

    @Test
    public void extractFirstWord_firstWord() throws Exception {
    ...
    @Test
    public void extractPrefixedWords_allTags() throws Exception {
    ...
    @Test
    public void extractPrefixedWords_tagsWithOtherWords() throws Exception {
    ...
    @Test
    public void extractTextFromIndex_indexWithKeywords() throws Exception {
    ...
    @Test
    public void extractTextFromIndex_indexWithoutKeywords() throws Exception {
    ...
    @Test
    public void extractTextAfterKeyword_keyword() throws Exception {
    ...
    @Test
    public void extractTextAfterKeyword_keywordNotFound() throws Exception {
    ...
    @Test
    public void extractTextAfterKeyword_caseInsensitive() throws Exception {
