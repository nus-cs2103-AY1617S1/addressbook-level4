...
public class XmlUtilTest {
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        XmlSerializableAddressBook dataToWrite = new XmlSerializableAddressBook(new TaskScheduler());
        ...
        AddressBookBuilder builder = new AddressBookBuilder(new TaskScheduler());
