...
public class XmlUtilTest {
    ...
    public void getDataFromFile_validFile_validResult() throws Exception {
        ...
        assertEquals(28, dataFromFile.getUndoneTaskList().size());
        assertEquals(2, dataFromFile.getDoneTaskList().size());
    }
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        dataToWrite = new XmlSerializableTaskManager(builder.withFloatingTask(TestUtil.generateSampleFloatingTaskData().get(0)).build());
