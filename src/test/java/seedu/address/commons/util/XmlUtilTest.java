...
public class XmlUtilTest {
    ...
    public void getDataFromFile_validFile_validResult() throws Exception {
        ...
        assertEquals(7, dataFromFile.getPersonList().size());
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        TaskManagerBuilder builder = new TaskManagerBuilder(new AddressBook());
        dataToWrite = new XmlSerializableAddressBook(builder.withItem(TestUtil.generateSampleItemData().get(0)).withTag("Friends").build());
