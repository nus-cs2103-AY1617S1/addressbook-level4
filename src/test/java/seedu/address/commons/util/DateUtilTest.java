...
public class DateUtilTest {
	...
	public void formatDayTests() {
	    ...
	    assertEquals(DateUtil.formatDay(now), "Today " + now.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.US).substring(0, 3) + " " + 
	    ...
	    assertEquals(DateUtil.formatDay(now.plus(1, ChronoUnit.DAYS)), "Tomorrow " + 
	            now.plus(1, ChronoUnit.DAYS).getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.US).substring(0, 3) + 
