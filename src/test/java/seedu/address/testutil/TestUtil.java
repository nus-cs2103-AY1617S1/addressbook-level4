...
public class TestUtil {
    ...
    private static Person[] getSamplePersonData() {
        try {
            return new Person[]{
                    new Person(new Name("Ali Muster"), new Phone("9482424"), new Start("hans@google.com"), new Address("4th street"), new UniqueTagList()),
                    new Person(new Name("Boris Mueller"), new Phone("87249245"), new Start("ruth@google.com"), new Address("81th street"), new UniqueTagList()),
                    new Person(new Name("Carl Kurz"), new Phone("95352563"), new Start("heinz@yahoo.com"), new Address("wall street"), new UniqueTagList()),
                    new Person(new Name("Daniel Meier"), new Phone("87652533"), new Start("cornelia@google.com"), new Address("10th street"), new UniqueTagList()),
                    new Person(new Name("Elle Meyer"), new Phone("9482224"), new Start("werner@gmail.com"), new Address("michegan ave"), new UniqueTagList()),
                    new Person(new Name("Fiona Kunz"), new Phone("9482427"), new Start("lydia@gmail.com"), new Address("little tokyo"), new UniqueTagList()),
                    new Person(new Name("George Best"), new Phone("9482442"), new Start("anna@google.com"), new Address("4th street"), new UniqueTagList()),
                    new Person(new Name("Hoon Meier"), new Phone("8482424"), new Start("stefan@mail.com"), new Address("little india"), new UniqueTagList()),
                    new Person(new Name("Ida Mueller"), new Phone("8482131"), new Start("hans@google.com"), new Address("chicago ave"), new UniqueTagList())
            };
