...
public class TestUtil {
    ...
    private static Task[] getSamplePersonData() {
        try {
            return new Task[]{
                    new Task(new Name("Ali Muster"), new Date(1346524199000l), new Date(1346524199000l), new Location("4th street"), new UniqueTagList())
...
//                    new Task(new Name("Ida Mueller"), new Phone("8482131"), new Email("hans@google.com"), new Address("chicago ave"), new UniqueTagList())
    ...
    public static TaskScheduler generateEmptyAddressBook() {
