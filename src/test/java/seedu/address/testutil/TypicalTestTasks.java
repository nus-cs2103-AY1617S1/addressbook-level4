...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            ...
            event1 =  new TaskBuilder().withName("hw 4").withStatus("not done").withTaskType("event").withStartDate(LocalDateTime.of(2013, 1, 1, 4, 6)).withEndDate(LocalDateTime.of(2013, 2, 3, 4, 6)).build();
            ...
            eventToday =  new TaskBuilder().withName("hw 6").withStatus("not done").withTaskType("event").withStartDate(LocalDateTime.now()).withEndDate(LocalDateTime.now().plusHours(2)).build();
            ...
            eventIn7Days =  new TaskBuilder().withName("lab 6").withStatus("not done").withTaskType("event").withStartDate(LocalDateTime.now().plusDays(4)).withEndDate(LocalDateTime.now().plusDays(6)).build();
