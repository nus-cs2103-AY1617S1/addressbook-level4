...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
        	...
        	date1 = sdf.parse("23/10/2016");
        	date2 = sdf.parse("25/11/2016");
        	date3 = sdf.parse("01/12/2016");
        	date4 = sdf.parse("14/01/2018");
        	date5 = sdf.parse("02/03/2017");
        	date6 = sdf.parse("03/11/2016");
