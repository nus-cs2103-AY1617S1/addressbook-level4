...
public class TestApp extends MainApp {
    ...
    protected static final String EMERALDO_NAME = "Test";
    protected Supplier<ReadOnlyEmeraldo> initialDataSupplier = () -> null;
    protected String saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyEmeraldo> initialDataSupplier, String saveFileLocation) {
        super();
    ...
    protected Config initConfig(String configFilePath) {
        ...
        config.setEmeraldoFilePath(saveFileLocation);
        config.setUserPrefsFilePath(DEFAULT_PREF_FILE_LOCATION_FOR_TESTING);
        config.setEmeraldoName(EMERALDO_NAME);
        return config;
    }
