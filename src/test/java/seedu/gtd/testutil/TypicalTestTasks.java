...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            ...
            carl = new TaskBuilder().withName("Carl Kurz").withPriority("9").withDueDate("12345").withAddress("wall street").build();
            daniel = new TaskBuilder().withName("Daniel Meier").withPriority("8").withDueDate("12345").withAddress("10th street").build();
            elle = new TaskBuilder().withName("Elle Meyer").withPriority("9").withDueDate("12345").withAddress("michegan ave").build();
            ...
            //Manually added
            hoon = new TaskBuilder().withName("Hoon Meier").withPriority("8").withDueDate("12345").withAddress("little india").build();
            ida = new TaskBuilder().withName("Ida Mueller").withPriority("8").withDueDate("12345").withAddress("chicago ave").build();
