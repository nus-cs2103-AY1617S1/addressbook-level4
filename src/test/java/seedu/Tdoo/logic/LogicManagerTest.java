...
public class LogicManagerTest {
	...
	public void execute_todo_done_undone() throws Exception {
		...
		assertCommandBehavior("undone todo 1", String.format(UndoneCommand.MESSAGE_DONE_TASK_SUCCESS, pTarget1),
				expectedAB, expectedList);

		assertCommandBehavior("done todo 3", String.format(DoneCommand.MESSAGE_DONE_TASK_SUCCESS, pTarget2), expectedAB,
				expectedList);

		assertCommandBehavior("undone todo 3", String.format(UndoneCommand.MESSAGE_DONE_TASK_SUCCESS, pTarget2),
				expectedAB, expectedList);
	...
	public void execute_event_done_undone() throws Exception {
		...
		assertCommandBehavior("undone event 1", String.format(UndoneCommand.MESSAGE_DONE_TASK_SUCCESS, pTarget1),
				expectedAB, expectedList);

		assertCommandBehavior("done event 3", String.format(DoneCommand.MESSAGE_DONE_TASK_SUCCESS, pTarget2),
				expectedAB, expectedList);

		assertCommandBehavior("undone event 3", String.format(UndoneCommand.MESSAGE_DONE_TASK_SUCCESS, pTarget2),
				expectedAB, expectedList);

		assertCommandBehavior("done event 43", Messages.MESSAGE_INVALID_TASK_DISPLAYED_INDEX, expectedAB, expectedList);

		assertCommandBehavior("undone event 43", Messages.MESSAGE_INVALID_TASK_DISPLAYED_INDEX, expectedAB,
				expectedList);
	}
