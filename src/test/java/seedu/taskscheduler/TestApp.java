...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyTaskScheduler> initialDataSupplier = () -> null;
    protected String saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyTaskScheduler> initialDataSupplier, String saveFileLocation) {
        super();
