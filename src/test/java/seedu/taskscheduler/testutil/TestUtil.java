...
//                    new Task(new Name("Ida Mueller"), new Phone("8482131"), new Email("hans@google.com"), new Address("chicago ave"), new UniqueTagList())
    ...
    public static void createDataFileWithSampleData(String filePath) {
        createDataFileWithData(generateSampleStorageTaskScheduler(), filePath);
    }
    ...
    public static TaskScheduler generateEmptyTaskScheduler() {
        return new TaskScheduler(new UniqueTaskList(), new UniqueTagList());
    }

    public static XmlSerializableTaskScheduler generateSampleStorageTaskScheduler() {
        return new XmlSerializableTaskScheduler(generateEmptyTaskScheduler());
    }
