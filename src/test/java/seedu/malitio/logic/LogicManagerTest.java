...
public class LogicManagerTest {
    ...
    private ReadOnlyMalitio latestSavedAddressBook;
    private boolean helpShown;
    private int targetedJumpIndex;

    @Subscribe
    private void handleLocalModelChangedEvent(MalitioChangedEvent abce) {
        latestSavedAddressBook = new Malitio(abce.data);
    }
    ...
    public void setup() {
        ...
        latestSavedAddressBook = new Malitio(model.getMalitio()); // last saved assumed to be up to date before.
        helpShown = false;
    ...
    private void assertCommandBehavior(String inputCommand, String expectedMessage,
                                       ReadOnlyMalitio expectedAddressBook,
        ...
        assertEquals(expectedAddressBook, model.getMalitio());
    ...
    public void execute_list_showsAllPersons() throws Exception {
        ...
        TestDataHelper helper = new TestDataHelper();
        Malitio expectedAB = helper.generateAddressBook(2);
    ...
    private void assertIndexNotFoundBehaviorForCommand(String commandWord) throws Exception {
        ...
        assertCommandBehavior(commandWord + " 3", expectedMessage, model.getMalitio(), personList);
    }
    ...
    public void execute_select_jumpsToCorrectPerson() throws Exception {
        ...
        Malitio expectedAB = helper.generateAddressBook(threePersons);
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws Exception {
        ...
        Malitio expectedAB = helper.generateAddressBook(fourPersons);
    ...
    class TestDataHelper{
         ...
         */
        Malitio generateAddressBook(int numGenerated) throws Exception{
            Malitio addressBook = new Malitio();
         ...
         */
        Malitio generateAddressBook(List<Task> persons) throws Exception{
            Malitio addressBook = new Malitio();
         ...
         */
        void addToAddressBook(Malitio addressBook, int numGenerated) throws Exception{
         ...
         */
        void addToAddressBook(Malitio addressBook, List<Task> personsToAdd) throws Exception{
