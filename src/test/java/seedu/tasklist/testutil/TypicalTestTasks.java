...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            ...
            task7 = new TaskBuilder().withTaskDetails("Start working on GES1025 essay").withStartTime("9am").withEndTime(null).withUniqueID(7).withPriority("low").build();
            ...
            task9 = new TaskBuilder().withTaskDetails("Buy groceries").withStartTime("5pm").withEndTime(null).withUniqueID(9).withPriority("med").build();
