...
public class LogicManagerTest {
    ...
    public void execute_add_invalidTaskData() throws Exception {
        ...
        assertCommandBehavior(
                "add Valid Name p/not_numbers e/valid@e.mail a/valid, whatnow", Phone.MESSAGE_PHONE_CONSTRAINTS);
        assertCommandBehavior(
                "add Valid Name p/12345 e/notAnEmail a/valid, whatnow", Email.MESSAGE_EMAIL_CONSTRAINTS);
        assertCommandBehavior(
