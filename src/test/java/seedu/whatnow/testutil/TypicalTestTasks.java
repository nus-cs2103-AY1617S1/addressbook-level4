...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            a = new TaskBuilder().withName("Apricot & Vanilla Shake").withTaskType("todo").withTags("low").build();
            b = new TaskBuilder().withName("Business meeting").withDate("24/12/2016").withTaskType("schedule").withTags("high").build();
            c = new TaskBuilder().withName("Chocolate cake mix").withDate("11/10/2017").withTaskType("todo").withTags("").build();
            d = new TaskBuilder().withName("Doggie food").withDate("18/12/2016").withTaskType("todo").withTags("medium").build();
            ...
            g = new TaskBuilder().withName("Grape juice").withTime("4.45pm").withTaskType("todo").withTags("low").build();
            j = new TaskBuilder().withName("Jam sanwich").withDate("today").withTime("3pm").withTaskType("todo").withTags("low").build();
            ...
            o = new TaskBuilder().withName("Overseas School Trip").withTaskType("todo").withStartDate("02/01/2020").withEndDate("05/01/2020").withTaskType("schedule").withTags("").build();
            p = new TaskBuilder().withName("Pool Party!").withStartTime("5.30pm").withEndTime("6.45pm").withTags("low").build();
            ...
            //Manually added
            h = new TaskBuilder().withName("Homemade avacado toast").withTaskType("todo").build();
            i = new TaskBuilder().withName("International Finance Forum").withTaskType("todo").withTags("high").build();
            ...
            v = new TaskBuilder().withName("Victorian Museum Opening").withDate("today").withStartTime("8am").withEndTime("10.45am").withTaskType("todo").build();
