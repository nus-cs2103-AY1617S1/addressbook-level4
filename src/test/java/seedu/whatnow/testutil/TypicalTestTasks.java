...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            ...
            g = new TaskBuilder().withName("Grape juice").withTime("4.45pm").withTaskType("schedule").withTags("low").build();
            ...
            p = new TaskBuilder().withName("Pool Party!").withStartTime("5.30pm").withEndTime("6.45pm").withTaskType("schedule").withTags("low").build();
