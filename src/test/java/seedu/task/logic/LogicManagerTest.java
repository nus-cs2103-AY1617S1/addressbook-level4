...
public class LogicManagerTest {
    ...
    public void execute_add_invalidArgsFormat() throws Exception {
        ...
        assertCommandBehavior(
                "add Valid Name 12345 e/valid@endTime.butNoPhonePrefix a/valid, startTime", expectedMessage);
        assertCommandBehavior(
                "add Valid Name p/12345 valid@endTime.butNoPrefix a/valid, startTime", expectedMessage);
        assertCommandBehavior(
                "add Valid Name p/12345 e/valid@endTime.butNoAddressPrefix valid, startTime", expectedMessage);
    }
