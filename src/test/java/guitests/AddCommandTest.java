...
public class AddCommandTest extends TaskListGuiTest {
    ...
    public void add() {
        ...
        TestFloatingTask floatingTaskToAdd = td.hoon;
    ...
    private void assertAddSuccess(TestFloatingTask floatingTaskToAdd, TestFloatingTask... currentList) {
        ...
        TestFloatingTask[] expectedList = TestUtil.addTasksToList(currentList, floatingTaskToAdd);
