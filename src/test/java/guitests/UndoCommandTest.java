...
// new TaskBuilder().withName("TODO
// 123").withStartDate("28-11-2016").withEndDate("29-11-2016").withPriority("1").withDone("false").build(),
// new TaskBuilder().withName("TODO
// 456").withStartDate("01-12-2016").withEndDate("02-12-2016").withPriority("1").withDone("false").build(),
// new TaskBuilder().withName("TODO
// 789").withStartDate("03-12-2016").withEndDate("04-12-2016").withPriority("1").withDone("false").build(),
// new TaskBuilder().withName("TODO
// 101112").withStartDate("03-12-2016").withEndDate("04-12-2016").withPriority("1").withDone("false").build()
// };
...
// new EventBuilder().withName("Event
// 123").withStartDate("11-12-2016").withEndDate("12-12-2016").withStartTime("01:00").withEndTime("01:30").withDone("false").build(),
// new EventBuilder().withName("Event
// 456").withStartDate("17-11-2016").withEndDate("18-11-2016").withStartTime("01:30").withEndTime("20:00").withDone("false").build(),
// new EventBuilder().withName("Eeambuilding
// 3").withStartDate("19-11-2016").withEndDate("20-11-2016").withStartTime("01:30").withEndTime("02:00").withDone("false").build(),
// new EventBuilder().withName("Essignment
// 4").withStartDate("11-12-2016").withEndDate("12-12-2016").withStartTime("01:00").withEndTime("01:30").withDone("false").build()
// };
...
// new DeadlineBuilder().withName("d
// 1").withStartDate("15-11-2017").withEndTime("10:00").withDone("false").build(),
// new DeadlineBuilder().withName("dd
// 1").withStartDate("16-11-2017").withEndTime("12:00").withDone("false").build(),
// new DeadlineBuilder().withName("ddd
// 3").withStartDate("17-11-2017").withEndTime("13:00").withDone("false").build(),
// new DeadlineBuilder().withName("dddd
// 3").withStartDate("18-11-2017").withEndTime("13:00").withDone("false").build()
// };
...
// TestTask taskToAdd = new TaskBuilder().withName("TODO
// 123").withStartDate("28-11-2016").withEndDate("29-11-2016").withPriority("1").withDone("false").build();
...
// IllegalValueException {
// TestEvent eventToAdd = new EventBuilder().withName("EVENT
// 123").withStartDate("01-01-2017").withEndDate("02-01-2017").withStartTime("01:30").withEndTime("02:00").withDone("false").build();
...
// TestDeadline deadlineToAdd = new DeadlineBuilder().withName("DEADLINE
...
// TestEvent[] expectedRemainder = currentList;
// String index = Integer.toString(targetIndexOneIndexed);
// commandBox.runCommand("edit event " + index + " name/DummyEditEvent
// from/25-12-2016 to/26-12-2016 at/12:00 to/16:00");
// commandBox.runCommand("undo");
//
// //confirm the list reverted back to the original list after undo
// assertTrue(eventListPanel.isListMatching(expectedRemainder));
...
// TestDeadline[] expectedRemainder = currentList;
// String index = Integer.toString(targetIndexOneIndexed);
// commandBox.runCommand("edit deadline " + index + " name/DummyEditDeadilne
// on/25-12-2016 at/14:00");
// commandBox.runCommand("undo");
//
// //confirm the list reverted back to the original list after undo
// assertTrue(deadlineListPanel.isListMatching(expectedRemainder));
