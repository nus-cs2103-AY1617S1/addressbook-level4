...
public class GapCommandTest extends FlexiTrackGuiTest {
    ...
    public void execute_gap_hour() throws Exception {
        ...
        String messageShown = "The earliest 1 hour gap are found... "
        ...
        messageShown = "The earliest 3 hours gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 08 2016 11:00" + "  to: " + "Nov 08 2016 15:00"
                + "\nBetween:  " + "Nov 08 2016 16:00" + "  to: " + "Nov 09 2016 14:00";
        assertGapCommandSuccess(gapUserCommand, messageShown);
        ...
        messageShown = "The earliest 7 hours gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 08 2016 16:00" + "  to: " + "Nov 09 2016 14:00"
        ...
        messageShown = "The earliest 4 hours gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 08 2016 11:00" + "  to: " + "Nov 08 2016 15:00";
        assertGapCommandSuccess(gapUserCommand, messageShown);
    }
    ...
    public void execute_gap_minute_test() throws Exception {
        ...
        String messageShown = "The earliest 40 minutes gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 08 2016 11:00" + "  to: " + "Nov 08 2016 15:00"
                + "\nBetween:  " + "Nov 08 2016 16:00" + "  to: " + "Nov 09 2016 14:00";
        assertGapCommandSuccess(gapUserCommand, messageShown);
        ...
        messageShown = "The earliest 30 minutes gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 08 2016 11:00" + "  to: " + "Nov 08 2016 15:00"
                + "\nBetween:  " + "Nov 08 2016 16:00" + "  to: " + "Nov 09 2016 14:00";
        assertGapCommandSuccess(gapUserCommand, messageShown);
        ...
        messageShown = "The earliest 1 minute gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00";
        assertGapCommandSuccess(gapUserCommand, messageShown);
    }
    ...
    public void execute_gap_day_test() throws Exception {
        ...
        String messageShown = "The earliest 2 days gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 09 2016 16:00" + "  to: " + "Nov 12 2016 10:00"
        ...
        messageShown = "The earliest 3 days gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 12 2016 14:00" + "  to: " + "Nov 18 2016 09:00"
        ...
        messageShown = "The earliest 1 day gap are found... "
                + "\nBetween:  now                        " + "  to: " + "Nov 08 2016 09:00"
                + "\nBetween:  " + "Nov 09 2016 16:00" + "  to: " + "Nov 12 2016 10:00"
                + "\nBetween:  " + "Nov 12 2016 14:00" + "  to: " + "Nov 18 2016 09:00"
