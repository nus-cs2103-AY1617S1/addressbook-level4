...
/**
 * Provides a handle for the panel containing the dated task list.
 */
public class UndatedListPanelHandle extends GuiHandle {

    public static final int NOT_FOUND = -1;
    public static final String CARD_PANE_ID = "#cardPane";

    private static final String TASK_LIST_VIEW_ID = "#undatedListView";

    public UndatedListPanelHandle(GuiRobot guiRobot, Stage primaryStage) {
    ...
    /**
     * Returns true if the list is showing the tasks details correctly and in correct order.
