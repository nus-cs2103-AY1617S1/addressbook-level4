...
public class PersonCardHandle extends GuiHandle {
    ...
    public boolean isSamePerson(ReadOnlyTask person){
        return getFullName().equals(person.getTaskDetails().taskDetails) && getPhone().equals("Starts:   "+person.getStartTime())
                && getEmail().equals("Ends:     "+person.getEndTime()) && getAddress().equals("Priority: "+person.getPriority().priorityLevel);
    }
