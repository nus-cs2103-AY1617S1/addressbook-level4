 ...
 */
public class UpcomingTasksHandle extends GuiHandle {

    public static final int NOT_FOUND = -1;
    public static final String CARD_PANE_ID = "#cardPane";

    private static final String TASK_LIST_VIEW_ID = "#upcomingTasksListView";

    public UpcomingTasksHandle(GuiRobot guiRobot, Stage primaryStage) {
