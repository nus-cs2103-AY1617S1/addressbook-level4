...
public class FindCommandTest extends TaskMasterGuiTest {
    ...
    public void find_nonEmptyList() {
        ...
        assertFindResult("find read", td.book.getTaskDateComponent().get(0), td.lecture.getTaskDateComponent().get(0)); // multiple
                                                                                                                        // results
    ...
    // @@author
    private void assertFindResult(String command, TaskOccurrence... expectedHits) {
