...
/**
 * A GUI Test class for Emeraldo.
 */
public abstract class EmeraldoGuiTest {
    ...
    protected Emeraldo getInitialData() {
        Emeraldo ab = TestUtil.generateEmptyEmeraldo();
        TypicalTestTasks.loadEmeraldoWithSampleData(ab);
        return ab;
    }
