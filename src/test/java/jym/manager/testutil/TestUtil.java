...
<<<<<<< HEAD:src/test/java/jym/manager/testutil/TestUtil.java
    /**
     * Folder used for temp files created during testing. Ignored by Git.
     */
...
>>>>>>> nus-cs2103-AY1617S1/master:src/test/java/seedu/address/testutil/TestUtil.java
            };
...
>>>>>>> nus-cs2103-AY1617S1/master:src/test/java/seedu/address/testutil/TestUtil.java
     ...
     * @return
     */
    public static String getFilePathInSandboxFolder(String fileDescription) {
        try {
            FileUtil.createDirs(new File(SANDBOX_FOLDER));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        return SANDBOX_FOLDER + fileDescription;
    }
    ...
    public static void captureScreenShot(String fileDescription) {
        File file = GuiTest.captureScreenshot();
        try {
            Files.copy(file, new File(fileDescription + ".png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
     ...
     */
    public static Method getPrivateMethod(Class objectClass, String methodDescription) throws NoSuchMethodException {
        Method method = objectClass.getDeclaredMethod(methodDescription);
        method.setAccessible(true);
        return method;
    }

    public static void renameFile(File file, String newFileDescription) {
        try {
            Files.copy(file, new File(newFileDescription));
