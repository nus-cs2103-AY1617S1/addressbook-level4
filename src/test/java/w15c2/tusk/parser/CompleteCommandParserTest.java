...
import w15c2.tusk.logic.parser.CompleteCommandParser;
...
public class CompleteCommandParserTest {
	...
	public void prepareCommand_validIndex() {		
		CompleteTaskCommand command = (CompleteTaskCommand) parser.prepareCommand("1");
		assertTrue(command.targetIndex == 1);
		
		command = (CompleteTaskCommand) parser.prepareCommand("1000");
