...
3. `undo`<br>
> **Result:**<br>
> 1.- Result display panel posts message:<br>
`Undid the most recent action.`
- TaskList panel displays the list of tasks before executre clear command.

> 2.
- Result display panel posts message:<br>
`Redid the most recent action that is undone. 
\nTo-do List has been cleared!`
- TaskList panel removes all tasks.

> 3. The result is the same as `1`
...
## 10. Filter Command
------
### 10.1 Filter by deadline and recurring
...
### 10.2 Filter by start date and end date
...
### 10.3 Filter by priority and tag
...
> **Command:** `change newFile.xml`<br>
> **Result:**
- Result display panel posts message:<br>
`Storage location changed: newFile.xml`
- Status Foot Bar updates to show the new location.
- Open the folder and the `sampleData.xml` and `newFile.xml` should be there.
...
> **Command:** `change toDoList.xml clear`<br>
> **Result:**
- Result display panel posts message:<br>
`Storage location changed: toDoList.xml`
- Status Foot Bar updates to show the new location.
