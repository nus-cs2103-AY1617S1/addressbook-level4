...
public class Parser {
	...
	private static final String[] ADD_TASK_KEYWORDS = {" at ", " by ", " from ", " to ", " p/", " t/"};

	private static final String[] UPDATE_TASK_KEYWORDS = {" at ", " by ", " from ", " to ", " p/", " t/"};
	...
	private Command prepareUpdate(String args) {
		...
		try {
			...
			return new UpdateCommand(index, name, startTime, endTime, priority, utags);
	...
	private Command prepareAdd(String args) {
		...
		try{
			...
			return new AddCommand(name, startTime, endTime, priority, utags);
		}
		catch(IllegalValueException ive){
			return new IncorrectCommand(ive.getMessage());
		}
