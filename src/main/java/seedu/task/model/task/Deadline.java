...
public class Deadline {
    ...
    public static final String MESSAGE_DEADLINE_CONSTRAINTS = "Task deadline should be in h:mmam or h:mmpm format";
    public static final String DEADLINE_VALIDATION_REGEX = "(^([0-9]{1}:[0-9]{2})([a|p]m))|(^.+)";
