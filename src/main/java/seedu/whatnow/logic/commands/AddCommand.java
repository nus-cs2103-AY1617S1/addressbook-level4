...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a task to WhatNow. \n"
            ...
            + " \"Buy dinner\" at 6pm t/highPriority\n" + COMMAND_WORD
            + " \"Lesson\" on 24/2/2017 from 8.30am to 4:30pm t/lowPriority\n" + COMMAND_WORD
            + " \"Submit homework\" by tomorrow 12pm t/lowPriority\n";
    ...
    // @@author A0126240W
    public AddCommand(String name, String date, String startDate, String endDate, String time, String startTime,
            String endTime, Set<String> tags) throws IllegalValueException, ParseException {
        ...
        this.toAdd = new Task(new Name(name), date, startDate, endDate, time, startTime, endTime,
