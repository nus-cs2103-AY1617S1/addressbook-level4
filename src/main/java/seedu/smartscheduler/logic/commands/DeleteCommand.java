...
import seedu.smartscheduler.commons.core.Messages;
import seedu.smartscheduler.commons.core.UnmodifiableObservableList;
import seedu.smartscheduler.model.task.ReadOnlyTask;
import seedu.smartscheduler.model.task.UniqueTaskList.PersonNotFoundException;
...
public class DeleteCommand extends Command {
    ...
    public CommandResult execute() {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_TASK_SUCCESS, personToDelete.getName()));
    }
