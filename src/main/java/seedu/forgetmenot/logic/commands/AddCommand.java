...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a task to the ForgetMeNot. "
            + "Parameters: TASKNAME DATE" + "Example: " + COMMAND_WORD + " Homework by tomorrow 6pm";
     ...
     */
    public AddCommand(String name, String date, String start, String end, String recur) throws IllegalValueException {
        ...
        // if(!Time.taskTimeisAfterCurrentTime(start) ||
        // !Time.taskTimeisAfterCurrentTime(end)) {
        // throw new IllegalValueException(MESSAGE_INVALID_TIME);
        // }

        this.toAdd = new Task(new Name(name), new Done(false), startTime, endTime, new Recurrence(recur));
    }
