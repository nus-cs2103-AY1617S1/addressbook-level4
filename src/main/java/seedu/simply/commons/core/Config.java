package seedu.simply.commons.core;
...
public class Config {
    ...
    private String appTitle = "Simply";
    ...
    public Config(Config config) {
        ...
        this.taskBookFilePath = config.getTaskBookFilePath();
        this.taskBookName = config.getTaskBookName();
    }
