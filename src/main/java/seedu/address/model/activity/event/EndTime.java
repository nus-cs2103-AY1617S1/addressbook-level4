...
public class EndTime extends DateTime {
    ...
    public EndTime(String starttime, String date) throws IllegalValueException {
        ...
        if (this.value.before(cal) && !this.recurring)
            ...
            while (this.value.before(startdate)) {
                ...
                else if (date.contains("mond") || date.contains("tues") || date.contains("wedn")
                        || date.contains("thur") || date.contains("frid") || date.contains("satu")
                        || date.contains("sund"))
