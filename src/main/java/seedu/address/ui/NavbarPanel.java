...
public class NavbarPanel extends UiPart {
    ...
    public final String NAVBAR_TASKS = " Tasks";
    public final String NAVBAR_DEADLINES = " Deadlines";
    public final String NAVBAR_INCOMING_DEADLINES = " Incoming Deadlines";
    public final String NAVBAR_FLOATING_TASKS = " Floating Tasks";
    public final String NAVBAR_COMPLETED = " Completed";
    
    public final ObservableList<String> navbarElement = FXCollections.observableArrayList(NAVBAR_TASKS, NAVBAR_DEADLINES, NAVBAR_FLOATING_TASKS
