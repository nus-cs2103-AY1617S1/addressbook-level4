...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_TASK_DISPLAYED_INDEX = "The item index provided is invalid";
    public static final String MESSAGE_ITEMS_LISTED_OVERVIEW = "%1$d items listed!";
    public static final String MESSAGE_DONE_LIST_RESTRICTED_COMMANDS = "Supported commands on done list: \n\t[clear][delete][exit][find]\n\t[help][list][redo][select][undo]";
    //@@author A0139498J
