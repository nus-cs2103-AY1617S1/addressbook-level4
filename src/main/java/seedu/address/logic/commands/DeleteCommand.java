...
public class DeleteCommand extends Command {
    ...
    public CommandResult execute() {
        ...
        UnmodifiableObservableList<ReadOnlyDatedTask> lastShownList = model.getFilteredPersonList();
        ...
        ReadOnlyDatedTask personToDelete = lastShownList.get(targetIndex - 1);
