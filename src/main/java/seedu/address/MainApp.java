...
public class MainApp extends Application {
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        try {
            ...
            initialData = addressBookOptional.orElse(new ToDo());
        } catch (DataConversionException e) {
            logger.warning("Data file not in the correct format. Will be starting with an empty ToDo");
            initialData = new ToDo();
        } catch (IOException e) {
            logger.warning("Problem while reading from the file. . Will be starting with an empty ToDo");
            initialData = new ToDo();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting ToDo " + MainApp.VERSION);
