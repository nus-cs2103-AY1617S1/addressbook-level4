...
public class MainWindow extends UiPart {
    ...
    private static final String ICON = "/images/Emeraldo_icon.png";
    ...
    public static MainWindow load(Stage primaryStage, Config config, UserPrefs prefs, Logic logic) {
        ...
        mainWindow.configure(config.getAppTitle(), config.getEmeraldoName(), config, prefs, logic);
        return mainWindow;
    }
    ...
    void fillInnerParts() {     
        ...
        statusBarFooter = StatusBarFooter.load(primaryStage, getStatusbarPlaceholder(), config.getEmeraldoFilePath());
