 ...
 */
public class OverdueTaskListPanel extends UiPart {
    ...
    public static OverdueTaskListPanel load(Stage primaryStage, AnchorPane taskListPlaceholder,
                                       ObservableList<ReadOnlyTask> taskList) {
        OverdueTaskListPanel taskListPanel =
                UiPartLoader.loadUiPart(primaryStage, taskListPlaceholder, new OverdueTaskListPanel());
