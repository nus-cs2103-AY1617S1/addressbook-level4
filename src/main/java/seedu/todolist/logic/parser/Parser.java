...
public class Parser {
    ...
    private AddCommand parseAddCommandWithInterval(String name, String[] interval, Set<String> tags) throws IllegalValueException {
        System.out.println("NAME : " + name);
        System.out.println("START DATE : " + interval[INTERVAL_COMPONENT_STARTDATE]);
