...
import seedu.dailyplanner.commons.core.Version;
...
import seedu.dailyplanner.commons.util.ConfigUtil;
...
import seedu.dailyplanner.ui.Ui;
import seedu.dailyplanner.ui.UiManager;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing DailyPlanner ]===========================");
        super.init();
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting DailyPlanner " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping Daily Planner ] =============================");
        ui.stop();
        try {
