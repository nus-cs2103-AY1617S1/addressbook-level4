...
public class TaskQuery extends Task {
  ...
  public final static String MESSAGE_BOTH_STATUS_SEARCHED_ERROR =
      "Both '-do (Done)' and '-ud (Undone)' flags " + "have been detected.\n"
          + "Please search for either '-do (Done)' or '-ud (Undone)' status";

  public TaskQuery() {}

  public TaskQuery(Name name, DateTime dateTime, Priority priority, Status status,
      UniqueTagList tags) {
  ...
  public void createPriorityQuery(String priorityString) throws IllegalValueException {
    ...
    /*
     * To convert long versions of priority strings (i.e. high, medium, low) into characters (i.e.
     * h, m, l)
     */
  ...
  public ArrayList<String> getNameKeywordsAsList() {
    return new ArrayList<String>(
        Arrays.asList(getName().taskName.split(StringUtil.STRING_WHITESPACE)));
  }
