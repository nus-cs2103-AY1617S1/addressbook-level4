...
public class UiColor {
    ...
    public static final String TASK_CARD_NEWLY_ADDED_BORDER = "-fx-border-color: #2E8AF7";
    public static final String TASK_CARD_DEFAULT_BORDER = "-fx-border-color: lightgrey";
