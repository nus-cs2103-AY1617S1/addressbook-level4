...
public class UserGuide {
    ...
    public static final String RSV_ID = "#Reserving_timeslots_for_a_task__rsv_55";
    public static final String RSV_DELETE_ID = "#Deleting_a_task_with_reserved_timeslots__rsv_del_66";
    public static final String CONFIRM_ID = "#Confirming_a_reserved_timeslot__confirm_79";
    ...
    public static final String MARK_UNDONE_ID = "#Marking_tasks_as_undone__ud_151";
    ...
    public static final String CLEAR_ID = "#Clearing_the_data_storage_file__clear_245";
    public static final String EXIT_ID = "#Exiting_the_program__exit_249";
    public static final String CD_ID = "#Changing_data_storage_location__cd_254";
