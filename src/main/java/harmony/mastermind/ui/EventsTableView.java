...
public class EventsTableView extends DefaultTableView {
    
    private static final String FXML = "EventsTableView.fxml";
    ...
    public static EventsTableView load(Stage primaryStage, AnchorPane defaultTableViewPlaceholder, Logic logic){
        EventsTableView ui = UiPartLoader.loadUiPart(primaryStage, defaultTableViewPlaceholder, new EventsTableView());
        ui.configure(logic);
        return ui;
    }
    ...
    public void setNode(Node node) {
        this.eventsTableView = (TableView<ReadOnlyTask>) node;
    }
    ...
    private void addToPlaceholder(){
        placeholder.getChildren().add(eventsTableView);
        FxViewUtil.applyAnchorBoundaryParameters(eventsTableView, 0, 0, 0, 0);
    }
    ...
    protected void initIndex() {
        indexColumn.prefWidthProperty().bind(eventsTableView.widthProperty().multiply(WIDTH_MULTIPLIER_INDEX));
    ...
    protected void initName() {
        nameColumn.prefWidthProperty().bind(eventsTableView.widthProperty().multiply(WIDTH_MULTIPLIER_NAME));
    ...
    protected void initStartDate() {
        startDateColumn.prefWidthProperty().bind(eventsTableView.widthProperty().multiply(WIDTH_MULTIPLIER_STARTDATE));
    ...
    protected void initEndDate() {
        endDateColumn.prefWidthProperty().bind(eventsTableView.widthProperty().multiply(WIDTH_MULTIPLIER_ENDDATE));
    ...
    protected void initTags() {
        tagsColumn.prefWidthProperty().bind(eventsTableView.widthProperty().multiply(WIDTH_MULTIPLIER_TAGS));
    ...
    protected void initRecur() {
        recurColumn.prefWidthProperty().bind(eventsTableView.widthProperty().multiply(WIDTH_MULTIPLIER_RECUR));
