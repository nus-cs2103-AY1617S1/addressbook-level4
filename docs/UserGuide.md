...
|:------|:-----------------|
|View help|`help`|
|Add a someday|`add (someday | sd) 'TASK_NAME'`|
|Add a deadline|`add (deadline | dl) 'TASK_NAME' by TIME DATE`|
|Add an event|`add (event | ev) 'TASK_NAME' from TIME DATE to TIME DATE`|
|List tasks|`list [TASK_TYPE] [done|not-done] [DATE]`|
