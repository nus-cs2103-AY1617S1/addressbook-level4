...
* [Features](#features)
   ...
   * [Undo the Most Recent Commands](#undo-the-most-recent-commands)
   * [Redo the Most Recent Undone Commands](#redo-the-most-recent-undone-commands)
   * [Clearing the program](#clearing-the-program)
