...
`Main` has only one class called [`MainApp`](../src/main/java/seedu/




/MainApp.java). It is responsible for,
...
>Note how the `Model` simply raises a `FlexiTrackChangedEvent` when the FlexiTrack data are changed,
...
//@@ author
**API** : [`Ui.java`](../src/main/java/seedu/flexitrack/ui/Ui.java)
...
The `UI` component uses JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files
 ...
 For example, the layout of the [`MainWindow`](../src/main/java/seedu/flexitrack/ui/MainWindow.java) is specified in
...
**API** : [`Logic.java`](../src/main/java/seedu/flexitrack/logic/Logic.java)
...
**API** : [`Model.java`](../src/main/java/seedu/flexitrack/model/Model.java)
...
<img src="images/StorageClassDiagram2.png" width="800"><br>

**API** : [`Storage.java`](../src/main/java/seedu/flexitrack/storage/Storage.java)
