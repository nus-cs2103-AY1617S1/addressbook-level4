...
</li><li>Manage tasks with as few keystrokes as possible</li><li>Works without internet connectivity</li></ol>|<ol type="1"><li>No block feature</li><li>Unable to look for suitable slot</li>
