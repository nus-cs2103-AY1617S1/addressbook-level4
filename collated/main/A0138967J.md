...
```
###### \java\seedu\todo\model\qualifiers\WeekDateQualifier.java
``` java
package seedu.todo.model.qualifiers;
...
```
###### \java\seedu\todo\ui\WeekSummaryCard.java
``` java
package seedu.todo.ui;
...
```
###### \java\seedu\todo\ui\WeekSummaryPanel.java
``` java
package seedu.todo.ui;
...
<VBox maxWidth="200.0" prefHeight="175.0" prefWidth="200.0" style="-fx-background-color: #FFFFFF;" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0" xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.todo.ui.SummaryPanel">
    <children>
      <Text opacity="0.6" strokeType="OUTSIDE" strokeWidth="0.0" text="Today" wrappingWidth="200.13671875">
         <font>
...
<VBox maxWidth="200.0" prefHeight="175.0" prefWidth="200.0" style="-fx-background-color: #FFFFFF;" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0" xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.todo.ui.WeekSummaryPanel">
    <children>
      <Text opacity="0.6" strokeType="OUTSIDE" strokeWidth="0.0" text="Next 7 Days" wrappingWidth="181.13671875">
         <font>
            <Font name="Arial Bold" size="30.0" />
         </font></Text>
