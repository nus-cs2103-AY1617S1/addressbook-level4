...
```
###### \java\harmony\mastermind\logic\commands\ActionHistoryCommand.java
``` java
/**
 * 
...
```
###### \java\harmony\mastermind\model\tag\UniqueTagList.java
``` java
    public String toString(){
...
```
###### \java\harmony\mastermind\model\task\TaskListComparator.java
``` java
