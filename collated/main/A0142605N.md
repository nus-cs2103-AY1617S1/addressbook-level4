               ...
               <children>
                  <HBox alignment="CENTER_LEFT">
                     <children>
                        ...
                        <Label fx:id="tag" styleClass="card-text" stylesheets="@DefaultTheme.css" text="\$tag" HBox.hgrow="ALWAYS" />
                     </children>
                  </HBox>
                  <Label fx:id="time" styleClass="card-text" stylesheets="@DefaultTheme.css" text="\$time" VBox.vgrow="ALWAYS" />
              </children>
            </VBox>
         </children>
      </HBox>
