...
<AnchorPane fx:id="cardPane" xmlns="http://javafx.com/javafx/8.0.60" xmlns:fx="http://javafx.com/fxml/1">
   <children>
      	...
      	<children>
      		<HBox alignment="CENTER_LEFT" spacing="5">
      			<children>
      				...
      				<Label id="priority" fx:id="priority" prefHeight="30.0" prefWidth="73.0" style="-fx-alignment: CENTER-RIGHT;" styleClass="cell_small_label" text="\$priority">

				</Label>
      				<Label fx:id="startTime" prefWidth="84.0" style="-fx-alignment: center;" styleClass="cell_small_label" text="\$startTime" />
      				<Label fx:id="endTime" prefWidth="84.0" style="-fx-alignment: center;" styleClass="cell_small_label" text="\$endTime" />
      			</children>
      		</HBox>
      		<HBox />
      	</children>
