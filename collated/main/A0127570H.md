# A0127570H
###### /java/seedu/task/commons/exceptions/EmptyValueException.java
``` java
/**
...
```
###### /java/seedu/task/logic/commands/AddEventCommand.java
``` java
/**
...
```
###### /java/seedu/task/logic/commands/AddTaskCommand.java
``` java
/**
...
```
###### /java/seedu/task/logic/commands/EditEventCommand.java
``` java
/**
...
```
###### /java/seedu/task/logic/commands/EditTaskCommand.java
``` java
/**
...
```
###### /java/seedu/task/model/item/Deadline.java
``` java
/**
...
```
###### /java/seedu/task/model/item/Description.java
``` java
...
```
###### /java/seedu/task/model/item/UniqueEventList.java
``` java
    /**
...
```
###### /java/seedu/task/model/item/UniqueTaskList.java
``` java
    /**
...
```
###### /java/seedu/task/storage/XmlAdaptedEvent.java
``` java
    /**
               ...
               <font>
                ...
                <VBox alignment="CENTER_LEFT" GridPane.columnIndex="0" VBox.vgrow="ALWAYS">
                    ...
                    <children>
                        ...
                        <Label fx:id="description" styleClass="cell_desc_label" text="\\$desc" wrapText="true">
                     <padding>
                        <Insets left="20.0" />
                     </padding></Label>
                        <Label fx:id="duration" styleClass="cell_ddl_label" text="\\$duration">
                     <padding>
                        <Insets left="20.0" />
                     </padding></Label>
                    </children>
               ...
               <font>
                ...
                <VBox alignment="CENTER_LEFT" GridPane.columnIndex="0" VBox.vgrow="ALWAYS">
                    ...
                    <children>
                        ...
                        <Label fx:id="description" styleClass="cell_desc_label" text="\\$desc" textFill="#685252" wrapText="true">
                     <padding>
                        <Insets left="20.0" />
                     </padding></Label>
                        <Label fx:id="deadline" styleClass="cell_ddl_label" text="\\$deadline">
                     <padding>
                        <Insets left="20.0" />
                     </padding></Label>
                    </children>
