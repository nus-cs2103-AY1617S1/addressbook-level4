...
```
###### \java\seedu\malitio\model\task\Deadline.java
``` java
    /**
...
```
###### \java\seedu\malitio\model\task\Event.java
``` java
    /**
...
```
###### \java\seedu\malitio\model\task\FloatingTask.java
``` java
    /**
...
```
###### \java\seedu\malitio\model\task\ReadOnlyDeadline.java
``` java
        /**
...
```
###### \java\seedu\malitio\model\task\ReadOnlyEvent.java
``` java
        /**
         * Returns true if both have the same state. (interfaces cannot override .equals)
         */
...
```
###### \java\seedu\malitio\model\task\ReadOnlyFloatingTask.java
``` java
    /**
     * Returns true if both have the same state. (interfaces cannot override .equals)
     */
