...
<VBox maxHeight="Infinity" maxWidth="Infinity" minHeight="-Infinity" minWidth="-Infinity" style="-fx-background-color: #FFFFFF;" stylesheets="@DarkTheme.css" xmlns="http://javafx.com/javafx/8.0.60" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.tasklist.ui.MainWindow">
   <children>
      ...
      <VBox style="-fx-alignment: center;" VBox.vgrow="NEVER">
         <children>
             <AnchorPane fx:id="resultDisplayPlaceholder" maxHeight="200.0" minHeight="24.0" prefHeight="150.0" prefWidth="1504.0" style="-fx-background-color: white; -fx-border-color: white;" styleClass="anchor-pane-with-border">
                 <padding>
                     ...
                     <children>
                        <HBox maxHeight="29.0" minHeight="29.0" prefHeight="29.0">
                           <children>
                              ...
                              <Label id="dateTimeLabel" fx:id="dateTimeLabel" maxWidth="1.7976931348623157E308" minWidth="470.0" text="Test" HBox.hgrow="ALWAYS">
                                 <padding>
                                    <Insets left="8.0" />
                                 </padding>
                              </Label>
                              <Label id="task_det" minWidth="83.0" prefWidth="83.0" text="Priority" />
                              <Label id="task_det" minWidth="84.0" prefWidth="84.0" text="Start" />
                              <Label id="task_det" minWidth="59.0" prefWidth="59.0" text="End" />
                           </children>
                        </HBox>
