...
<VBox maxHeight="Infinity" maxWidth="Infinity" minHeight="-Infinity" minWidth="-Infinity" style="-fx-background-color: #FFFFFF;" stylesheets="@DarkTheme.css" xmlns="http://javafx.com/javafx/8.0.60" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.tasklist.ui.MainWindow">
   <children>
      <SplitPane prefHeight="39.0" prefWidth="1115.0" style="-fx-border-color: white;">
         <items>
            <Pane minHeight="35.0" prefHeight="35.0" prefWidth="1108.0" style="-fx-background-color: white; -fx-border-color: white;">
               <children>
                  <Pane>
                     <children>
                        ...
                        <Label id="task_det" layoutX="799.0" layoutY="4.0" text="Start" />
                        <Label id="task_det" layoutX="900.0" layoutY="4.0" text="End" />
                        <Label id="task_det" layoutX="708.0" layoutY="4.0" text="Priority" />
                     </children>
                  </Pane>
               </children>
            </Pane>
      ...
      <VBox style="-fx-alignment: center;" VBox.vgrow="NEVER">
         <children>
             <AnchorPane fx:id="resultDisplayPlaceholder" maxHeight="155.0" minHeight="24.0" prefHeight="67.0" prefWidth="1504.0" style="-fx-background-color: white; -fx-border-color: white;" styleClass="anchor-pane-with-border">
                 <padding>
