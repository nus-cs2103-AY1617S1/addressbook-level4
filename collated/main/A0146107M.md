...
<VBox maxHeight="Infinity" maxWidth="Infinity" minHeight="-Infinity" minWidth="-Infinity" style="-fx-background-color: #444444;" stylesheets="@DarkTheme.css" xmlns="http://javafx.com/javafx/8.0.60" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.tasklist.ui.MainWindow">
   <children>
      <SplitPane style="-fx-border-color: white;">
               ...
               <children>
                  <Pane layoutX="382.0">
                     <children>
                        ...
                        <Label id="task_det" layoutX="798.0" layoutY="4.0" text="Start" />
       ...
       <AnchorPane fx:id="resultDisplayPlaceholder" maxHeight="139.0" minHeight="62.0" prefHeight="139.0" prefWidth="1504.0" style="-fx-background-color: white; -fx-border-color: white;" styleClass="anchor-pane-with-border" VBox.vgrow="NEVER">
           <padding>
