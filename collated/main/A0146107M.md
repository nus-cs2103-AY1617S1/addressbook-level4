...
```
###### /java/seedu/tasklist/ui/TaskCard.java
``` java
                     ...
                     <children>
                        <HBox maxHeight="29.0" minHeight="29.0" prefHeight="29.0">
                           <children>
                              ...
                              <Label id="dateTimeLabel" fx:id="dateTimeLabel" maxWidth="1.7976931348623157E308" minWidth="363.0" prefHeight="30.0" prefWidth="507.0" text="Test" HBox.hgrow="ALWAYS">
                                 <padding>
                                    <Insets left="8.0" />
                                 </padding>
                              </Label>
                              <Label id="task_det" minWidth="83.0" prefHeight="30.0" prefWidth="131.0" text="Priority" />
                              <Label id="task_det" minWidth="84.0" prefWidth="66.0" text="Start" />
