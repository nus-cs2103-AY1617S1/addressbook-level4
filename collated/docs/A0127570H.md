...
> 4. Allows for association with Projects (Tag the task with â€˜+â€™)
> 5. Allows for adding of context; where and with what, (Tag the task with â€˜@â€™)
> 6. Archives completed tasks to Done.txt for future reference
> 7. Suitable for programmers with intuitive UNIX commands such as â€˜lsâ€™
...
<em> <code>edit /t 1 /desc CS2103 Project /by 12-30-16</code><br><br />
  Edits the description of the 1st task to â€œCS2103 Projectâ€? and the deadline to 30 Dec<br />
</em> <code>edit /t 4 /desc CS2103 TaskBook</code><br><br />
  Edits the description of the 4th task to â€œCS2103 TaskBookâ€?</p>
...
<em> <code>edit /e 1 /desc CS2103 Workshop /from 10-03-16 0000 /to 10-05-16 2359</code><br />
  Edits the description of the 1st event to â€œCS2103 Workshopâ€? and the duration to the period of 0000 hours, 3-10-16 to 2359 hours, 5-10-16<br />
</em> <code>edit /e 4 /desc CS2103 TaskBook Project Meeting 4</code><br />
  Edits the description of the 4th task to â€œCS2103 TaskBook Project Meeting 4â€?</p>
```
###### \UserGuide.md
``` md
...
* `edit /t 1 /desc CS2103 Project /by 12-30-16`<br>
  Edits the description of the 1st task to â€œCS2103 Projectâ€? and the deadline to 30 Dec
* `edit /t 4 /desc CS2103 TaskBook`<br>
  Edits the description of the 4th task to â€œCS2103 TaskBookâ€?
...
* `edit /e 1 /desc CS2103 Workshop /from 10-03-16 0000 /to 10-05-16 2359`  
  Edits the description of the 1st event to â€œCS2103 Workshopâ€? and the duration to the period of 0000 hours, 3-10-16 to 2359 hours, 5-10-16
* `edit /e 4 /desc CS2103 TaskBook Project Meeting 4`  
  Edits the description of the 4th task to â€œCS2103 TaskBook Project Meeting 4â€?
