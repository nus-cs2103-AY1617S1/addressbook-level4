...
This command will show you the command format of the specific command you have entered in the result display panel. For example, if i type â€œhelp add,â€? the result display panel will show the specific format of the add command. 
