...
Help command opens a html file with Command Summary. <br>
Format: `help`

> * Opens the help window. Last pressed key to access command summary is ENTER. Therefore, the same ENTER key can be pressed to close the browser window.  

#### Command summary: `show`
Show command for floating and Overdue tasks. <br>
Format: `show floating`
Format: `show Overdue`
> * Shows the all the floating tasks or overdue tasks, depending on the input command.  
```
