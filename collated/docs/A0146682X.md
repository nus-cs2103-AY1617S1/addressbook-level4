...
* Able to unmark a â€œcompletedâ€? task by a simple click
...
* Includes two tabs of â€œtodayâ€? and â€œweekâ€? which highlight the most recent tasks
...
* Does not display todayâ€™s date
